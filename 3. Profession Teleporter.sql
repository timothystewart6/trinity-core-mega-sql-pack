...
@ENTRY2              := 190002,
@NAME                := "Wu",
@SUBNAME             := "Profession Teleporter",
@CONFIRM             := "Are you sure?",
@COMMENT             := "profession teleporter";

DELETE FROM creature_template WHERE entry = @ENTRY1;
DELETE FROM creature_template WHERE entry = @ENTRY2;
DELETE FROM npc_text WHERE id = @TEXT_ID;
DELETE FROM gossip_menu_option WHERE menu_id = @GOSSIP_MENU1;
DELETE FROM gossip_menu_option WHERE menu_id = @GOSSIP_MENU2;
DELETE FROM conditions WHERE SourceGroup = @GOSSIP_MENU1;
DELETE FROM conditions WHERE SourceGroup = @GOSSIP_MENU2;
DELETE FROM smart_scripts WHERE entryorguid = @ENTRY1;
...
(@GOSSIP_MENU1, 9, 0, "Plaza", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU1, 4, 0, "Enchanting", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU1, 5, 0, "Inscription", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU1, 6, 0, "Jewelcrafting", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU1, 7, 0, "Leatherworking", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU1, 8, 0, "Tailoring", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU1, 3, 0, "Engineering", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU1, 2, 0, "Cooking", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU1, 1, 0, "Blacksmithing", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU1, 0, 0, "Alchemy", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU2, 0, 0, "Alchemy", 1, 1, @GOSSIP_MENU2, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU2, 1, 0, "Blacksmithing", 1, 1, @GOSSIP_MENU2, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU2, 2, 0, "Cooking", 1, 1, @GOSSIP_MENU2, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU2, 3, 0, "Engineering", 1, 1, @GOSSIP_MENU2, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU2, 4, 0, "Enchanting", 1, 1, @GOSSIP_MENU2, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU2, 5, 0, "Inscription", 1, 1, @GOSSIP_MENU2, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU2, 6, 0, "Jewelcrafting", 1, 1, @GOSSIP_MENU2, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU2, 7, 0, "Leatherworking", 1, 1, @GOSSIP_MENU2, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU2, 8, 0, "Tailoring", 1, 1, @GOSSIP_MENU2, 0, 0, 0, @CONFIRM),
(@GOSSIP_MENU2, 9, 0, "Plaza", 1, 1, @GOSSIP_MENU1, 0, 0, 0, @CONFIRM);
...
(@ENTRY1, 0, 8, 0, 62, 0, 100, 0, @GOSSIP_MENU1, 8, 0, 0, 62, 1, 0, 0, 0, 0, 0, 7, 0, 0, 0, 1799.66, -4557.08, 23.0063, 4.61495, @COMMENT),
(@ENTRY1, 0, 7, 0, 62, 0, 100, 0, @GOSSIP_MENU1, 7, 0, 0, 62, 1, 0, 0, 0, 0, 0, 7, 0, 0, 0, 1850.56, -4561.53, 24.9852, 5.12546, @COMMENT),
(@ENTRY1, 0, 6, 0, 62, 0, 100, 0, @GOSSIP_MENU1, 6, 0, 0, 62, 1, 0, 0, 0, 0, 0, 7, 0, 0, 0, 1896.6, -4324.84, 23.396, 2.7575, @COMMENT),
(@ENTRY1, 0, 5, 0, 62, 0, 100, 0, @GOSSIP_MENU1, 5, 0, 0, 62, 1, 0, 0, 0, 0, 0, 7, 0, 0, 0, 1840.64, -4471.6, 47.6865, 1.60295, @COMMENT),
(@ENTRY1, 0, 4, 0, 62, 0, 100, 0, @GOSSIP_MENU1, 4, 0, 0, 62, 1, 0, 0, 0, 0, 0, 7, 0, 0, 0, 1916.94, -4432.5, 24.7964, 3.37011, @COMMENT),
(@ENTRY1, 0, 3, 0, 62, 0, 100, 0, @GOSSIP_MENU1, 3, 0, 0, 62, 1, 0, 0, 0, 0, 0, 7, 0, 0, 0, 2040.66, -4741.5, 29.3859, 4.45787, @COMMENT),
(@ENTRY1, 0, 2, 0, 62, 0, 100, 0, @GOSSIP_MENU1, 2, 0, 0, 62, 1, 0, 0, 0, 0, 0, 7, 0, 0, 0, 1774.08, -4487.64, 45.6483, 1.46157, @COMMENT),
(@ENTRY1, 0, 1, 0, 62, 0, 100, 0, @GOSSIP_MENU1, 1, 0, 0, 62, 1, 0, 0, 0, 0, 0, 7, 0, 0, 0, 2059, -4829.45, 24.5775, 4.28902, @COMMENT),
(@ENTRY1, 0, 0, 0, 62, 0, 100, 0, @GOSSIP_MENU1, 0, 0, 0, 62, 1, 0, 0, 0, 0, 0, 7, 0, 0, 0, 1953.83, -4472.89, 25.9586, 6.22502, @COMMENT),
(@ENTRY2, 0, 8, 0, 62, 0, 100, 0, @GOSSIP_MENU2, 8, 0, 0, 62, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, -8943.3, 794.673, 90.9426, 1.64026 , @COMMENT),
(@ENTRY2, 0, 7, 0, 62, 0, 100, 0, @GOSSIP_MENU2, 7, 0, 0, 62, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, -8721.74, 473.066, 98.6133, 1.76591, @COMMENT),
(@ENTRY2, 0, 6, 0, 62, 0, 100, 0, @GOSSIP_MENU2, 6, 0, 0, 62, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, -8664.52, 431.722, 100.909, 3.81188, @COMMENT),
(@ENTRY2, 0, 5, 0, 62, 0, 100, 0, @GOSSIP_MENU2, 5, 0, 0, 62, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, -8855.72, 859.289, 99.6101, 3.26603, @COMMENT),
(@ENTRY2, 0, 4, 0, 62, 0, 100, 0, @GOSSIP_MENU2, 4, 0, 0, 62, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, -8855.05, 799.975, 96.3345, 1.91122, @COMMENT),
(@ENTRY2, 0, 3, 0, 62, 0, 100, 0, @GOSSIP_MENU2, 3, 0, 0, 62, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, -8350.34, 642.508, 95.2935, 0.685993, @COMMENT),
(@ENTRY2, 0, 2, 0, 62, 0, 100, 0, @GOSSIP_MENU2, 2, 0, 0, 62, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, -8612.35, 361.786, 99.6287, 5.46514, @COMMENT),
(@ENTRY2, 0, 1, 0, 62, 0, 100, 0, @GOSSIP_MENU2, 1, 0, 0, 62, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, -8424.08, 623.769, 95.5974, 3.85508, @COMMENT),
(@ENTRY2, 0, 0, 0, 62, 0, 100, 0, @GOSSIP_MENU2, 0, 0, 0, 62, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, -8985.07, 757.731, 98.3301, 3.89043, @COMMENT),
(@ENTRY1, 0, 9, 0, 62, 0, 100, 0, @GOSSIP_MENU1, 9, 0, 0, 62, 1, 0, 0, 0, 0, 0, 7, 0, 0, 0, 1629.36, -4373.39, 31.2564, 3.54839, @COMMENT),
(@ENTRY2, 0, 9, 0, 62, 0, 100, 0, @GOSSIP_MENU2, 9, 0, 0, 62, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, -8833.38, 628.628, 94.0066, 1.06535, @COMMENT);
...
(15118039, @ENTRY2, 0, 1, 1, 0, 0, -8835.704102, 644.569641, 95.536003, 4.354766, 300, 0, 0, 5342, 0, 0, 0, 0, 0),
...
(15118038, @ENTRY1, 1, 1, 1, 0, 0, 1581.446655, -4397.694336, 6.263248, 5.291983, 300, 0, 0, 5342, 0, 0, 0, 0, 0),
