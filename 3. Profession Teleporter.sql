...
REPLACE INTO `creature_template` (entry,modelid1,name,iconname,gossip_menu_id,minlevel,maxlevel,faction,npcflag,scale,unit_class,unit_flags,type,ainame,inhabittype,flags_extra) VALUES 
(@ENTRY1, 30414, "Professions Teleporter", "Directions", 60000, 80, 80, 35, 3, 2.5, 1, 2, 7, "SmartAI", 3, 2),
(@ENTRY2, 30414, "Professions Teleporter", "Directions", 60001, 80, 80, 35, 3, 2.5, 0, 0, 7, "SmartAI", 3, 2);
...
(@GOSSIP_MENU1, 9, 0, "Plaza", 1, 1, @GOSSIP_MENU1, 0, 0, 0, "Are you sure?"),
...
(@GOSSIP_MENU2, 9, 0, "Plaza", 1, 1, @GOSSIP_MENU1, 0, 0, 0, "Are you sure?");
